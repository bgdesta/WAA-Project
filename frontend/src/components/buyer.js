      ...
      <div>
        ...
        <div className="divbuttommargin">
          ...
          <p className="gclass">
            ...
            ProMotion. Huge camera system upgrade for dramatic new
            possibilities. Exceptional durability. The ultrafast A15 Bionic
            chip. And breakthrough battery life. Let’s Pro.{" "}
          </p>
        ...
        <div className="divbuttommargin">
          ...
          <p className="gclass">
            With the Samsung Galaxy M31 - Samsung re-introduces the powerful
            6000 mAh battery along with all round features comprising of a 64 MP
            rear camera in Quad camera set up and an immersive samoled screen.
            Screen Size: 6.4″, Weight: 6.74 oz, Display Resolution:2340 x 1080,
        ...
        <div className="divbuttommargin">
          ...
          <p className="gclass">
            product Name: Apple Watch:Graphite Stainless Steel Case with
            Milanese Loop The stainless steel case is durable and polished to a
            shiny, mirror-like finish. The Milanese Loop is made from a smooth
            stainless steel mesh that’s fully magnetic, so it’s infinitely
            adjustable for a perfect fit.{" "}
          </p>
          <p className="gclass">
            Connectivity What’s the difference between GPS and GPS + Cellular?
            GPS + Cellular Make calls and send messages with just your Apple
            Watch. Works with Family Setup.
          </p>
